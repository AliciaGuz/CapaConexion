    ...
    public partial class Form1 : Form
    {
        ...
        private void cargarbtn_Click(object sender, EventArgs e)
        {
            SqlConnection connection =
                new SqlConnection
                ("Data Source=DESKTOP-EP7G28B\\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True");
            MessageBox.Show("Conexión iniciada");
            connection.Open();
            ...
            SqlCommand comando = new SqlCommand(selectFrom, connection);
            ...
            connection.Close();
            MessageBox.Show("Conexión finalizada con éxito");
        }
        ...
        {
            string cadenaConecction = DatosLayer.DataBase.ConnectionString;
